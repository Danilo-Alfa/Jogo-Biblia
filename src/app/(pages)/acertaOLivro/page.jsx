...
const BibleNumberGame = () => {
  ...
  const getButtonStyle = (option) => {
    let baseStyle =
      "w-full p-4 rounded-xl font-semibold text-left transition-all duration-300 transform hover:scale-102 ";
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl">
            ...
            <div className="mt-6 bg-indigo-500/10 rounded-xl p-4">
              ...
              <p className="text-white text-sm text-center">
                Livros 1-39:{" "}
                <span className="text-amber-400">Antigo Testamento</span> •
                Livros 40-66:{" "}
                <span className="text-blue-400">Novo Testamento</span>
              </p>
            </div>
          </div>
        </div>
